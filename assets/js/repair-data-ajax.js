$(document).ready(function () {
  ...
  $(document).delegate('.edit', 'click', function() {
    ...
    repair_or_service.html("<select class='form-control'><option value='1'>Repair</option><option value='2'>Service</option></select>");
  ...
  $(document).delegate('#save', 'click', function() {
    ...
    $.ajax({
      ...
      data: 'repair_id=' + repair_id.html() + 
            '&repair_or_service=' + repair_or_service.children().val() + 
      ...
      success: function() {
        var html = '';
        switch (repair_or_service.children().val()) {
          case '1':
            status_html = '<button type=\'button\' class=\'btn btn-sm btn-success\'>Repair</button>';
            break;
          case '2':
            status_html = '<button type=\'button\' class=\'btn btn-sm btn-primary\'>Service</button>';
            break;
        }
        repair_or_service.html(status_html);
        ...
        buttons.html("<button type='button' class='edit btn btn-sm btn-outline-danger' repair_id='" + repair_id.html() + "'>Edit</button>&nbsp;&nbsp;<button type ='button' class='delete btn btn-sm btn-outline-danger' repair_id='" + repair_id.html() + "'>Delete</button>");
      },
      error: function() {
